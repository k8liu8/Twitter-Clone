...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "xJC8f7ACekd6pk0CaOOEl5C3F", consumerSecret: "CxA2CQHd38MvxFPflQ4plV9TphHozewccFY8ZyqbMUffaCM3S9")
    var loginSuccess: (() -> ())?
